...
echo 'alias tnm-chain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/tnmchain/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/tnmchain/core'"
...
rm -rf "$HOME/.config/@tnm-chain"
rm -rf "$HOME/.config/@tnm-chain"
rm -rf "$HOME/.config/tnm-chain-core"
